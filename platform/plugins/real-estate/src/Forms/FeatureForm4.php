...
class FeatureForm4 extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('name', 'text', [
                'label'      => trans('plugins/real-estate::feature4.form.name'),
                'label_attr' => ['class' => 'control-label required'],
                'attr'       => [
                    'placeholder'  => trans('plugins/real-estate::feature4.form.name'),
                    'data-counter' => 120,
                ],
            ])
            ->add('icon', 'fontawesomeSelect', [
                ...
                'attr'          => [
                    'placeholder'  => trans('plugins/real-estate::feature4.form.icon'),
                    'data-counter' => 60,
                ],

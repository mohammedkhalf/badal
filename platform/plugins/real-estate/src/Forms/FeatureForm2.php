...
class FeatureForm2 extends FormAbstract
{
    ...
    public function buildForm()
    {
        $this
            ...
            ->add('name', 'text', [
                'label'      => trans('plugins/real-estate::feature2.form.name'),
                'label_attr' => ['class' => 'control-label required'],
                'attr'       => [
                    'placeholder'  => trans('plugins/real-estate::feature2.form.name'),
                    'data-counter' => 120,
                ],
            ])
            ->add('icon', 'fontawesomeSelect', [
                'label'         => trans('plugins/real-estate::feature2.form.icon'),
                'label_attr'    => ['class' => 'control-label'],
                'attr'          => [
                    'placeholder'  => trans('plugins/real-estate::feature2.form.icon'),
                    'data-counter' => 60,
                ],

...
class FeatureForm9 extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('name', 'text', [
                'label'      => trans('plugins/real-estate::feature9.form.name'),
                'label_attr' => ['class' => 'control-label required'],
                'attr'       => [
                    'placeholder'  => trans('plugins/real-estate::feature9.form.name'),
                    'data-counter' => 120,
                ],
            ])
            ->add('icon', 'fontawesomeSelect', [
                'label'         => trans('plugins/real-estate::feature9.form.icon'),
                'label_attr'    => ['class' => 'control-label'],
                'attr'          => [
                    'placeholder'  => trans('plugins/real-estate::feature9.form.icon'),
                    'data-counter' => 60,
                ],

...
namespace Theme\badal\Http\Controllers;
...
use SlugHelper;
use Theme;
use Theme\badal\Http\Resources\AgentHTMLResource;
use Theme\badal\Http\Resources\PostResource;
use Theme\badal\Http\Resources\PropertyHTMLResource;
use Theme\badal\Http\Resources\PropertyResource;
use Theme\badal\Http\Resources\ReviewResource;
use Theme\badal\Http\Resources\TestimonialResource;
use Botble\Base\Supports\Language;

class badalController extends PublicController
{
    /**
     * @param string            $key
